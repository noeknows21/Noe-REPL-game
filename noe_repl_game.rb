...
when "mk"
  ...
  if duplicate_resolution == 1
    ...
    puts "Duplicate resolution unsuccessful. You will henceforth be known as Mortal Kombat"
    ...
    if 0.3 + x > rand
      ...
      if $die_game_attempts < 3
        ...
        if $die_game_response == "1"
          ...
          puts "Grog: 'BAR'S CLOSING. You ain't gotta go home but you gotta GTFO of
here.'"
        puts "GAME OVER"
        else
